...
namespace Gork
{
    ...
    public abstract class GorkDialogueProvider : MonoBehaviour
    {
        ...
        /// <summary>
        /// Will append a new text <paramref name="line"/> to the <see cref="lines"/> list. <para/>
        /// If no dialogue lines at all are present, then a new dialogue is started instead.
        /// </summary>
        public static DialogueLineText AppendTextDialogue(string line, bool nextLineIsChoiceLine = false)
        {
            return AppendTextDialogue(line, null, nextLineIsChoiceLine);
        }
        /// <summary>
        /// Will append a new text <paramref name="line"/> to the <see cref="lines"/> list. <para/>
        /// If no dialogue lines at all are present, then a new dialogue is started instead.
        ...
        {
            return AppendChoiceDialogue((ICollection<string>)choices);
        }
        ...
        /// Override if you want to add custom behaviour for when a new text line is added. <para/>
        /// Will by default just add the <paramref name="textLine"/> to the <see cref="lines"/> list and then start the dialogue coroutine if it's not already active by calling <see cref="TryStartDialogueCoroutine"/>.
        /// </summary>
        ...
        /// Override if you want to add custom behaviour for when a new choice line is added. <para/>
        /// Will by default just add the <paramref name="choiceLine"/> to the <see cref="lines"/> list and then start the dialogue coroutine if it's not already active by calling <see cref="TryStartDialogueCoroutine"/>.
        /// </summary>
        ...
        /// Will by default just add the <paramref name="line"/> to the <see cref="lines"/> list and then start the dialogue coroutine if it's not already active by calling <see cref="TryStartDialogueCoroutine"/>.
        /// </summary>
